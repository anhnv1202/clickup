! function(e) {
    function r(r) {
        for (var n, u, i = r[0], c = r[1], f = r[2], l = 0, p = []; l < i.length; l++) u = i[l], Object.prototype.hasOwnProperty.call(o, u) && o[u] && p.push(o[u][0]), o[u] = 0;
        ...
        if (0 !== t)
            if (t) r.push(t[2]);
                ...
                i.charset = "utf-8", i.timeout = 120, u.nc && i.setAttribute("nonce", u.nc), i.src = function(e) {
                    return u.p + "js/widget-sandboxed-chunks/" + ({}[e] || e) + "-" + {
                        0: "0bf7e82babe160f02ef7",
                        1: "5a4cd69050add3d94f1d",
                        2: "ab0d599d0b3aa54d7754",
                        3: "8af78b77ec665483efaf",
                        4: "1dddc3f089387ddc7701",
                        5: "d6dac7f20ac4f82dd73b"
                    }[e] + ".chunk.js"
                }(e);
                var c = new Error;
                a = function(r) {
    ...
    }, u.p = "/packs/", u.oe = function(e) {
        throw console.error(e), e
    };
    var i = window.qualifiedWebpackJsonp = window.qualifiedWebpackJsonp || [],
        c = i.push.bind(i);
    i.push = r, i = i.slice();
